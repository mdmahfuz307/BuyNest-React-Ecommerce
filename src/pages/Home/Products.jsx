  ...
  return (
    <div className="max-w-screen-2xl container mx-auto xl:px-28 px-4 mb-12">
      <div className="text-center mb-12 animate-fadeIn">
        <h2 className="text-4xl md:text-5xl font-bold capitalize mb-4 text-Black">
          Featured Products
        </h2>
        <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
          Browse through our handpicked selection of premium products. Filter by category, sort by price or name, and find exactly what you're looking for with ease.
        </p>
      </div>
      ...
      <div>
        ...
        <FaFilter className="text-white h-4 w-4"/>
          ...
          <select
            ...
            value={sortOption}
            className="bg-black text-center text-white px-2 py-2 rounded-md cursor-pointer" 
          >
